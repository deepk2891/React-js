				...
				<div className="flex flex-col xl:flex-row text-lg">
					<div className="text-center xl:w-2/5 p-4">
						<div>
							...
							<button type="submit" className="block w-full border border-indigo-500 text-lg py-2 px-6 bg-indigo-600 text-white hover:bg-white hover:text-indigo-400">
								Add user
							</button>
						</div>
					</div>
						...
						<div className="text-center">
							...
							<div className="table-container overflow-x-auto">
								<table className="table-auto border border-gray-500 mx-auto w-full">
									...
									<tbody className="js-user-list"></tbody>
								</table>
							</div>
						</div>
					</div>
